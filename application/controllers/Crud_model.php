...
public function get_data($table,$where = array(),$single_row = false,$join = array(), $like = array(),$select = "*",$or_where = "",$where_in = "", $order_by = "",$notequal = ""){
		...
		if (!empty($notequal)) {
			$this->db->where("classes.ticket_id != level_test");
		}
